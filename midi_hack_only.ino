...
void setup() {
  ...
  pinMode(WIRE_A, INPUT);
  pinMode(WIRE_B, INPUT);
  pinMode(WIRE_C, INPUT);
  pinMode(WIRE_D, INPUT);
  pinMode(WIRE_E, INPUT);
  pinMode(WIRE_F, INPUT);
  pinMode(WIRE_G, INPUT);
  pinMode(WIRE_H, INPUT);
  ...
  pinMode(WIRE_7, INPUT);
  pinMode(WIRE_8, INPUT);
